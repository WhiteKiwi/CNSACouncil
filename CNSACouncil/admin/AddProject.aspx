<%@ Page Title="" Language="C#" MasterPageFile="~/masters/Admins.Master" AutoEventWireup="true" CodeBehind="AddProject.aspx.cs" Inherits="CNSACouncil.admin.AddProject" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Contents" runat="server">
	...
	<form runat="server" class="p-5">
		...
		<div class="text-center">
			<asp:Button runat="server" ID="UploadButton" CssClass="btn btn-lg btn-danger btn-square w-25" Text="등록하기" OnClick="UploadButton_Click" />
		</div>
	</form>
