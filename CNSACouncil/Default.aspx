	...
	<div class="container-fluid main-contents row color-black">
		...
		<div class="float-left col-md-6">
			...
			<div class="w-100 content-div">
				...
				<h5 class="float-right content-date">2018-05-26</h5>
			</div>
			<br />
			<div class="w-100 content-div">
				<a href="/" class="content-link">
		...
		<div class="float-right col-md-6">
			...
			<div class="w-100 content-div">
				...
				<h5 class="float-right content-date color-gold">진행중</h5>
			</div>
			<br />
			<div class="w-100 content-div">
				<a href="/" class="content-link">
				...
				<h5 class="float-right content-date color-black">진행완료</h5>
			</div>
			<br />
			<div class="w-100 content-div">
				<a href="/" class="content-link">
